...
const About = ({ offset, factor = 1 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      ...
      <SVG icon="circle" hiddenMobile width={12} color="icon_darkest" left="10%" top="60%" />
      <SVG icon="box" hiddenMobile width={6} color="icon_orange" left="10%" top="10%" />
      <SVG icon="box" hiddenMobile width={12} color="icon_darkest" left="20%" top="22%" />
